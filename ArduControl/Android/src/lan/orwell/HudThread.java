...
public class HudThread extends Thread {
	...
	public HudThread(SurfaceHolder surfaceHolder, Context context, Handler handler,HudSurface gEngineS){
	...
	public void run() {
		...
		while (state==RUNNING) {
			...
			try {
				...
				Logger.getLogger(HudThread.class.getName()).log(Level.SEVERE, null, ex);
			}
