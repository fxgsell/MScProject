...
public class HudControls implements OnTouchListener{
	...
	//425 = 39
	//267 = 419
	public float initx = 39;
	public float inity = 419;
	public Point _touchingPoint = new Point(39, 419);
	...
	public void update(MotionEvent event){
		...
		if ( _dragging ){
			...
			// bound to a box
			if( _touchingPoint.x < 419-25){
				_touchingPoint.x = 419-25;
			}
			if ( _touchingPoint.x > 419+25){
				_touchingPoint.x = 419+25;
			}
			if (_touchingPoint.y < 39-25){
				_touchingPoint.y = 39-25;
			}
			if ( _touchingPoint.y > 39+25 ){
				_touchingPoint.y = 39+25;
			}
