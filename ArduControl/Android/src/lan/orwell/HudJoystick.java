...
public class HudJoystick {
	...
	public HudJoystick(Resources res){
		
		_joystick = (Bitmap)BitmapFactory.decodeResource(res, lan.orwell.R.drawable.joystick);
		_joystickBg = (Bitmap)BitmapFactory.decodeResource(res, lan.orwell.R.drawable.joystick_bg);
