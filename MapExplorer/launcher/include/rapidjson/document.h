...
public:
	...
	*/
	GenericDocument(Allocator* allocator = 0, size_t stackCapacity = kDefaultStackCapacity) : GenericValue<Encoding, Allocator>(), stack_(allocator, stackCapacity), parseError_(0), errorOffset_(0) {}
...
private:
	// Prohibit assignment
	GenericDocument(GenericDocument const &);
