...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/tim/MScProject/MapExplorer/launchMapExplorer/src/launcher/${idir})
      set(include /home/tim/MScProject/MapExplorer/launchMapExplorer/src/launcher/${idir})
    else()
      message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/MScProject/MapExplorer/launchMapExplorer/src/launcher/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tim/MScProject/MapExplorer/launchMapExplorer/src/launcher/devel/lib;/opt/ros/groovy/lib)
